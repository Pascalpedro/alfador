...
export function CTABand({
  title = "Let's transform your business operations.",
  description = "Tell us your business goals. We’ll build the technology, secure your assets, and handle the implementation from start to finish.",
}: {
  title?: string;
  description?: string;
}) {
  return (
    <Container className="pb-4">
      <div className="overflow-hidden rounded-3xl bg-ink px-6 py-14 text-center text-primary-foreground md:px-16 md:py-20">
        <h2 className="mx-auto max-w-2xl text-3xl font-semibold leading-tight md:text-4xl">{title}</h2>
